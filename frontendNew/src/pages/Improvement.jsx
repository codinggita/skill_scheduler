  ...
  return (
    <div className="flex bg-gray-100 w-screen h-[calc(100vh-64px)] mt-[64px] overflow-y-auto">
      <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 transform transition-all hover:shadow-lg animate-fade-in delay-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Weak Subjects */}
          <div className="bg-white rounded-lg shadow-sm p-6 transform transition-all hover:scale-102 animate-fade-in delay-200">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 transform transition-all hover:shadow-lg animate-fade-in delay-300">
          <h2 className="text-lg font-semibold mb-4">Study Habits Analysis</h2>
          <p className="text-gray-600 mb-6">
            Based on your study patterns, we've noticed that you tend to study more effectively in the morning hours.
            However, your study sessions are often interrupted, which may affect your learning retention. We recommend
            establishing more consistent study blocks and minimizing distractions during these periods.
          </p>
        ...
        <div className="text-center text-sm text-gray-500 animate-fade-in delay-400">
